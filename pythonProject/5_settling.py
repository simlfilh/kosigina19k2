...
st.markdown("""
    ...
    <div class="colored-container">
        ...
        <p>Обращаем Ваше внимание, что в нашем Университете действует система дистанционного бронирования.
        Возможность бронирования общежития будет доступна в личном кабинете студента, доступ к которому 
        будет предоставлен после выхода приказов о зачислении.</p>
        <br>
        <p>Обучающиеся льготных категорий заселяются преимущественно в общежития СПбГЭУ.
        Перед заселением в общежитие обучающимся, имеющим льготы, необходимо предоставить 
        ...
        <br>
        <p>❗️ Обучающимся, зачисленным на программы среднего профессионального образования (СПО), 
...
st.markdown("""
    <div class="colored-container">
        ...
        <p><b>3.</b> 2 фото формата 3х4;</p>
        <p><b>4.</b> Для несовершеннолетних обучающихся: оригинал нотариально заверенного согласия родителей 
        ...
        <p><b>1.</b> Для несовершеннолетних обучающихся: оригинал нотариально заверенного согласия родителей 
        (опекунов) на заключение договора найма жилого помещения в общежитии
        (<a href="https://unecon.ru/wp-content/uploads/2022/05/obrazec_soglasiya_dlya_roditeley_opekunov_0.pdf">образец заявления</a>);</p>
        ...
        """, unsafe_allow_html=True)
st.markdown("Копии документов предоставляются с оригиналами документов.")
...
st.markdown("""
    <div class="colored-container">
        ...
        <p><b>•</b> <a href="https://kosigina19k2.streamlit.app/">пр. Косыгина, д. 19/2</a> (блочный тип), метро «Ладожская»;</p>
        <p><b>•</b> <a href="https://voronezhskaya38.streamlit.app/">Воронежская ул., д. 38</a> (коридорный тип), метро «Обводный канал»;</p>
        <p><b>•</b> <a href="https://voronezhskaya69.streamlit.app/">Воронежская ул., д. 69</a> (блочный тип), метро «Обводный канал»;</p>
        <p><b>•</b> <a href="https://chkalovski27.streamlit.app/">Чкаловский пр., д. 27</a> (коридорный тип), метро «Чкаловская», «Петроградская».</p>
            <br>
