...
st.markdown("""
    ...
    <div class="colored-container">
        <p>Если Вы отсутствуете в общежитии БОЛЕЕ 5 ДНЕЙ, Вы можете подать заявление на 
        перерасчет за коммунальные услуги.</p>
    </div>
...
st.markdown("""
    <div class="colored-container">
        ...
        отсутствие.</p>
        <p><b>5.</b> Заявление заполняется на имя заведующего Александра Владимировича.</p>
    </div>
            """, unsafe_allow_html=True)
